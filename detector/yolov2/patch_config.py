...
class BaseConfig(object):
    ...
    def __init__(self):
        ...
        self.cfgfile = "model/darknet/yolo.cfg"
        self.weightfile = "model/darknet/yolo.weights"
        self.printfile = "non_printability/30values.txt"
        self.class_name = 'model/darknet/coco.names'
        self.patch_size = 300
        ...
        self.scheduler_factory = lambda x: optim.lr_scheduler.ReduceLROnPlateau(x, 'min', patience=50, factor=0.5)
        self.max_tv = 0
